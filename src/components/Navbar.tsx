  ...
  return (
    <nav className=' sticky top-0 z-50 border-b border-gray-200 bg-white backdrop-blur'>
     ...
     <div className='mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-10'>
        ...
        <button onClick={()=> setIsOpen(!isOpen)} className='text-xl  text-gray-700 md:hidden' aria-label='Toggle menu'>
        {isOpen ? <FaXmark/> : <FaBars/>}</button>
       <img src={Logo} alt="" />
      
       <div className='hidden items-center gap-7 md:flex'>
        <a href="" className='text-sm text-gray-700 hover:text-orange-500'>Home</a>
        <a href="" className='text-sm text-gray-700 hover:text-orange-500'>Technology</a>
        <a href="" className='text-sm text-gray-700 hover:text-orange-500'>Projects</a>
        <a href="" className='text-sm text-gray-700 hover:text-orange-500'>About</a>
        <a href="" className='text-sm text-gray-700 hover:text-orange-500'>Contact</a>
       </div>

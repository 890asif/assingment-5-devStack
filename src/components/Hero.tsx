...
const Hero = () => {
    return (
        <div className='flex items-center gap-10 px-30'>
            <div>

            <h1 className='text-5xl font-semibold'>Build Your Ideal</h1>
            <h1 className='text-5xl font-semibold bg-gradient-to-r from-orange-500 via-pink-500 to-purple-800 bg-clip-text
